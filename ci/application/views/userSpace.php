...
-->
		<?php foreach($cont as $temp):?>
			<li class = "block">
				<a href = "<?php echo site_url("space/index/".$temp["commer"])?>"><img class = "block liImg" src = "<?php echo site_url('space/index/'.$temp['userPhoto'])?>" alt = "<?php echo $temp["name"]?>" title = "<?php echo $temp["name"]?>"/></a>	
				<a href = "<?php echo site_url('showart/index/'.$temp['art_id'])?>"><p class = "detail"><?php echo $temp["title"]?></p></a>
				<p class = "user st"><?php if($temp["new"]) echo $temp["name"]?></p>
